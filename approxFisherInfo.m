function [I] = approxFisherInfo(pi_1, P, emission_means, chol_emission_covs,...
    target_placement, mu1, chol_Sig1, l_dirs, orth_l_dirs, median_norm_u,...
    movement_z, epsilon, delta, n_samples)
% Approximates the Fisher Information of the HMM at the given parameter
% settings, using (forward) finite differences to approximate gradients,
% and Monte Carlo samples to approximate the expectation
...
%     *********************************************************************
    ...
    grad = approxGradLogLYU(y, p_ugx, pi_1, P, emission_means,...
        emission_covs, double(zero_prob), delta);
    I = grad * grad';
